...
- [ ] **Vercel deploy.** Add `TURSO_DATABASE_URL`, `TURSO_AUTH_TOKEN`, `AI_GATEWAY_API_KEY` to Vercel project settings. The spec specifies `.vercel.app` hosting.
